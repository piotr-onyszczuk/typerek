// Licence file C:\Users\piotr\Documents\ReversePOCO.txt not found.
...
namespace Typerek.Database
{
    ...
    public interface IEntityContext : IDisposable
    {
        ...
        DbSet<RodzajZdarzenia> RodzajZdarzenias { get; set; } // rodzaj_zdarzenia
    ...
    public class EntityContext : DbContext, IEntityContext
    {
        ...
        public DbSet<RodzajZdarzenia> RodzajZdarzenias { get; set; } // rodzaj_zdarzenia
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new RodzajZdarzeniaConfiguration());
    ...
    public class FakeEntityContext : IEntityContext
    {
        ...
        public FakeEntityContext()
        {
            ...
            RodzajZdarzenias = new FakeDbSet<RodzajZdarzenia>("Id");
    ...
    public class RodzajZdarzenia
    {
        ...
        /// <summary>
        /// Child Zdarzenies where [zdarzenie].[RODZAJ_ID] point to this entity (FK__zdarzenie__RODZA__6754599E)
        /// </summary>
        public virtual ICollection<Zdarzenie> Zdarzenies { get; set; } // zdarzenie.FK__zdarzenie__RODZA__6754599E

        public RodzajZdarzenia()
        {
            Zdarzenies = new List<Zdarzenie>();
        }
    }
    ...
    public class Zdarzenie
    {
        ...
        public int RodzajId { get; set; } // RODZAJ_ID
        ...
        /// <summary>
        /// Parent RodzajZdarzenia pointed by [zdarzenie].([RodzajId]) (FK__zdarzenie__RODZA__6754599E)
        /// </summary>
        public virtual RodzajZdarzenia RodzajZdarzenia { get; set; } // FK__zdarzenie__RODZA__6754599E
    }
    ...
    // rodzaj_zdarzenia
    public class RodzajZdarzeniaConfiguration : IEntityTypeConfiguration<RodzajZdarzenia>
    {
        public void Configure(EntityTypeBuilder<RodzajZdarzenia> builder)
        {
            builder.ToTable("rodzaj_zdarzenia", "dbo");
            builder.HasKey(x => x.Id).HasName("PK__rodzaj_z__3214EC27F5186B0E").IsClustered();
    ...
    public class ZdarzenieConfiguration : IEntityTypeConfiguration<Zdarzenie>
    {
        public void Configure(EntityTypeBuilder<Zdarzenie> builder)
        {
            ...
            builder.Property(x => x.RodzajId).HasColumnName(@"RODZAJ_ID").HasColumnType("int").IsRequired();
            ...
            builder.HasOne(a => a.RodzajZdarzenia).WithMany(b => b.Zdarzenies).HasForeignKey(c => c.RodzajId).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__zdarzenie__RODZA__6754599E");
        }
    }
